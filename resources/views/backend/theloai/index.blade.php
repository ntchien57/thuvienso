        ...
        <tbody>
            @foreach ($listTheloai as $theloai)
                <tr>
                    ...
                    <td>
                        <a class="btn btn-primary" href="{{ url('admin/theloai/edit', ['id' => $theloai->id]) }}"><i
                                class="far fa-edit"></i></a>

                    </td>
                    <td>
                        <form name="frmDeleteTheloai" id="frmDeleteTheloai" method="post"
                            action="{{ url('admin/theloai', ['id' => $theloai->id]) }}">
                            {{ csrf_field() }}
