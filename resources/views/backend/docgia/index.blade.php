    ...
    <table class="table table-bordered table-hover table-responsive">
        ...
        <tbody>
            @foreach ($listDocgia as $docgia)
                <tr>
                    <td>
                        <a class="btn btn-primary" href="{{ url('admin/docgia/edit', ['id' => $docgia->id]) }}"><i
                                class="far fa-edit"></i></a>

                    </td>
                    <td>
                        <form name="frmDeleteDocgia" id="frmDeleteDocgia" method="post"
                            action="{{ url('admin/docgia', ['id' => $docgia->id]) }}">
                            {{ csrf_field() }}
