    ...
    <div id="mainmenu">
        <div id="menucontact" style="width:1140px;margin: auto;position: relative;">
            <div style="width: 220px;">
                <p style="height:35px;background: #0052CC;width: 230px;cursor:default;">&nbsp;<span><i class="fa fa-bars m-2 text-light" aria-hidden="true"></i><b
            ...
            <div style="float:right;height: 32px;position: absolute;right: 1px;top: 5px;" class="d-flex">
                <a class="text-dark mr-5" style="font-weight: bold;" href="">Trang chủ</a>
                <a class="text-dark mr-5" style="font-weight: bold;" href="">Sách yêu thích</a>
